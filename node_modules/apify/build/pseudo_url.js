...
class PseudoUrl {
  constructor(purl, requestTemplate = {}) {
    (0, _utils.checkParamOrThrow)(purl, 'purl', 'String|RegExp');
    (0, _utils.checkParamOrThrow)(requestTemplate, 'requestTemplate', 'Object');
    ...
    if (purl instanceof RegExp) {
      ...
      _log.default.debug('PURL parsed', {
        purl,
        regex
      });
  ...
  matches(url) {
    return _underscore.default.isString(url) && url.match(this.regex) !== null;
  }
  /**
  ...
  createRequest(urlOrProps) {
    const props = typeof urlOrProps === 'string' ? {
      url: urlOrProps
    } : urlOrProps;
    props.userData = { ...this.requestTemplate.userData,
      ...props.userData
    };
    const options = { ...this.requestTemplate,
      ...props
    }; // props.userData will override template with merged data.

    return new _request.default(options);
  }

}

var _default = PseudoUrl;
