...
class Statistics {
  constructor(options = {}) {
    ...
    (0, _utils.checkParamOrThrow)(logIntervalSecs, 'options.logIntervalSecs', 'Number');
    (0, _utils.checkParamOrThrow)(logMessage, 'options.logMessage', 'String');
  ...
  startLogging() {
    this.logInterval = setInterval(() => {
      _log.default.info(this.logMessage, this.getCurrent());
  ...
  _saveRetryCountForJob(job) {
    ...
    this.jobRetryHistogram[retryCount] = this.jobRetryHistogram[retryCount] ? this.jobRetryHistogram[retryCount] + 1 : 1;
  }
