...
class SystemStatus {
  constructor(options = {}) {
    ...
    (0, _utils.checkParamOrThrow)(currentHistorySecs, 'options.currentHistorySecs', 'Number');
    (0, _utils.checkParamOrThrow)(maxMemoryOverloadedRatio, 'options.maxMemoryOverloadedRatio', 'Number');
    (0, _utils.checkParamOrThrow)(maxEventLoopOverloadedRatio, 'options.maxEventLoopOverloadedRatio', 'Number');
    (0, _utils.checkParamOrThrow)(maxCpuOverloadedRatio, 'options.maxCpuOverloadedRatio', 'Number');
    (0, _utils.checkParamOrThrow)(maxClientOverloadedRatio, 'options.maxClientOverloadedRatio', 'Number');
    (0, _utils.checkParamOrThrow)(snapshotter, 'options.snapshotter', 'Maybe Object');
    ...
    this.snapshotter = snapshotter || new _snapshotter.default();
  }
  /**
  ...
  _isSampleOverloaded(sample, ratio) {
    ...
    const wAvg = (0, _utils2.weightedAvg)(values, weights);
    return {
