...
const BASE_PATH = exports.BASE_PATH = '/v2/acts';
...
exports.default = {
    ...
    runAct: (requestPromise, options) => {
        ...
        return requestPromise(opts).then(response => JSON.parse(response)).then(_utils.pluckData).then(_utils.parseDateFields);
    },
    ...
    createActVersion: (requestPromise, options) => {
        ...
        (0, _utils.checkParamOrThrow)(actId, 'actId', 'String');
        (0, _utils.checkParamOrThrow)(token, 'token', 'String');
        (0, _utils.checkParamOrThrow)(actVersion, 'actVersion', 'Object');
    ...
    getActVersion: (requestPromise, options) => {
        ...
        (0, _utils.checkParamOrThrow)(actId, 'actId', 'String');
        (0, _utils.checkParamOrThrow)(token, 'token', 'Maybe String');
        (0, _utils.checkParamOrThrow)(versionNumber, 'versionNumber', 'String');
