...
var _log = require('apify-shared/log');
...
const BASE_PATH = exports.BASE_PATH = '/v2/actor-tasks';
...
exports.default = {
    ...
    createTask: (requestPromise, options) => {
        ...
        (0, _utils.checkParamOrThrow)(baseUrl, 'baseUrl', 'String');
        (0, _utils.checkParamOrThrow)(token, 'token', 'String');
        (0, _utils.checkParamOrThrow)(task, 'task', 'Object');
    ...
    updateTask: (requestPromise, options) => {
        ...
        if (taskId) (0, _utils.checkParamOrThrow)(taskId, 'taskId', 'String');else (0, _utils.checkParamOrThrow)(task.id, 'task.id', 'String');
        ...
        return requestPromise({
            ...
            method: 'PUT',
            qs: { token },
            body: _underscore2.default.omit(task, 'id')
        }).then(_utils.pluckData).then(_utils.parseDateFields);
    },
    ...
    runTask: (requestPromise, options) => {
        ...
        (0, _utils.checkParamOrThrow)(input, 'input', 'Maybe Object');
        ...
        if (webhooks) query.webhooks = (0, _utils.stringifyWebhooksToBase64)(webhooks);
        ...
        if (body) {
            ...
            (0, _utils.checkParamOrThrow)(body, 'body', 'String');
            _log2.default.deprecated('Parameter "body" of client.tasks.runTask() method is depredated. Use "input" parameter instead.');
            opts.body = body;
        ...
        return requestPromise(opts).then(response => opts.json ? response : JSON.parse(response)).then(_utils.pluckData).then(_utils.parseDateFields);
    },
    ...
    updateInput: (requestPromise, options) => {
        ...
        (0, _utils.checkParamOrThrow)(token, 'token', 'String');
        (0, _utils.checkParamOrThrow)(taskId, 'taskId', 'String');
        (0, _utils.checkParamOrThrow)(input, 'input', 'Object');
