...
const BASE_PATH = exports.BASE_PATH = '/v1';
...
exports.default = {
    ...
    listCrawlers: (requestPromise, options) => {
        ...
        const queryString = _underscore2.default.pick(options, 'token', 'offset', 'limit', 'desc');
        ...
        return requestPromise({
            ...
            isApiV1: true
        }).then(_utils.wrapArray).then(_utils.parseDateFields);
    },
    ...
    createCrawler: (requestPromise, options) => {
        ...
        return requestPromise(requestParams).then(_utils.parseDateFields);
    },
    ...
    getCrawlerSettings: (requestPromise, options) => {
        ...
        (0, _utils.checkParamOrThrow)(token, 'token', 'String');
        (0, _utils.checkParamOrThrow)(crawlerId, 'crawlerId', 'String');
        (0, _utils.checkParamOrThrow)(executionId, 'executionId', 'Maybe String');

        const queryString = _underscore2.default.pick(options, 'token', 'nosecrets', 'executionId');
        ...
        return requestPromise({
            ...
            qs: queryString,
            isApiV1: true
        }).then(_utils.parseDateFields).catch(_utils.catchNotFoundOrThrow);
    },
    ...
    startExecution: (requestPromise, options) => {
        ...
        const queryString = _underscore2.default.pick(options, 'token', 'tag', 'wait');
    ...
    getListOfExecutions: (requestPromise, options) => {
        ...
        const queryString = _underscore2.default.pick(options, 'token', 'status', 'offset', 'limit', 'desc');
        ...
        return requestPromise({
            ...
            resolveWithFullResponse: true,
            isApiV1: true
        }).then(_utils.parseDateFields).then(_utils.wrapArray);
    },
    ...
    getLastExecution: (requestPromise, options) => {
        ...
        const queryString = _underscore2.default.pick(options, 'token', 'status');
    ...
    getExecutionResults: (requestPromise, options) => {
        ...
        const queryString = _underscore2.default.pick(options, 'format', 'simplified', 'offset', 'limit', 'desc', 'attachment', 'delimiter', 'bom', 'xmlRoot', 'xmlRow', 'hideUrl', 'skipFailedPages', 'skipHeaderRow');
        if (!_underscore2.default.isEmpty(queryString)) {
            requestParams.qs = queryString;
        }

        return requestPromise(requestParams).then(_utils.wrapArray);
    },
    ...
    getLastExecutionResults: (requestPromise, options) => {
        ...
        const queryString = _underscore2.default.pick(options, 'status', 'token', 'format', 'simplified', 'offset', 'limit', 'desc', 'attachment', 'delimiter', 'bom', 'xmlRoot', 'xmlRow', 'hideUrl', 'skipFailedPages', 'skipHeaderRow');
        if (!_underscore2.default.isEmpty(queryString)) {
            requestParams.qs = queryString;
        }
